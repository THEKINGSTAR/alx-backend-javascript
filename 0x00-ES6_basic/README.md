...
>- ### in your project directory, install Jest, Babel and ESList by using the sup```plied package.```json and run npm install.
>- 
## ```Configuration files```
>- ### Add the files below to your pro```ject directory```
>- 
>- ## package.json
```json
